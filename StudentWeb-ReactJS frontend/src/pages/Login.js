  ...
  function handleSubmit(event) {
    ...
    LoginFunc(stateData)
      .then((response) => {
        ...
        toast.success("Uspešno ste prijavljeni " + user.username);
      })
      .catch((error) => {
      ...
      <div className="Login container" style={{minHeight:"500px"}}>
        <div className="row">
          <div className="col-md-6 offset-md-3">
            <Card className="my-2 shadow" style={{backgroundColor:"rgb(240, 255, 255)"}}>
              <CardHeader>
                <h2 style={{textAlign:"center"}}>PRIJAVI SE</h2>
              </CardHeader>
              <CardBody>
              ...
              <CardFooter className="text-center">
                <NavLink to="/signup"  style={{ color: "rgb(125, 249, 255)" }}>
                  Još uvek se nisi registrovao/la? Registruj se odmah!
                </NavLink>
              </CardFooter>
            </Card>
          </div>
